...
def getArticlesRawV2(fromDate, toDate, categories, wordsSearch, optAndOr, selectNewspaper):
    ...
    # Si hay noticias pero no categorias
...
def graphFrequency(articles):
    ...
    p = figure(x_range=words, plot_height=300, plot_width=1000)
